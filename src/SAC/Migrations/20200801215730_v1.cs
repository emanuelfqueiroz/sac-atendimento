    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProtocoloId = table.Column<string>(nullable: false),
                    DigitroId = table.Column<string>(nullable: true),
                    ...
                    DtAlterado = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Protocolos", x => x.ProtocoloId);
                    table.ForeignKey(
                        name: "FK_Protocolos_Assunto_AssuntoId",
                        column: x => x.AssuntoId,
                        principalTable: "Assunto",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Protocolos_Cliente_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Cliente",
                        principalColumn: "Documento",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Protocolos_Motivo_MotivoId",
                        column: x => x.MotivoId,
                        principalTable: "Motivo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Protocolos_Setor_SetorId",
                        column: x => x.SetorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(nullable: true),
                    ProtocoloId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Documento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Documento_Protocolos_ProtocoloId",
                        column: x => x.ProtocoloId,
                        principalTable: "Protocolos",
                        principalColumn: "ProtocoloId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documento_ProtocoloId",
                table: "Documento",
                column: "ProtocoloId");

            migrationBuilder.CreateIndex(
                name: "IX_Protocolos_AssuntoId",
                table: "Protocolos",
                column: "AssuntoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Protocolos_MotivoId",
                table: "Protocolos",
                column: "MotivoId");

            migrationBuilder.CreateIndex(
                name: "IX_Protocolos_SetorId",
                table: "Protocolos",
                column: "SetorId");
        }
